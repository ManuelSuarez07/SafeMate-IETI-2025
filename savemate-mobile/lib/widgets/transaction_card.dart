...
class TransactionCard extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              // Detalles adicionales (si showDetails es true)
              if (showDetails && _hasAdditionalDetails(transaction)) ...[
                const SizedBox(height: 12),
                const Divider(height: 1),
                const SizedBox(height: 12),
                _buildAdditionalDetails(transaction),
              ],
            ],
          ),
        ),
  ...
  Widget _buildAdditionalDetails(Transaction transaction) {
    return Column(
      children: [
        if (transaction.originalAmount != null && transaction.roundedAmount != null) ...[
          _buildDetailRow(
            'Redondeo automático',
            '\$${transaction.originalAmount!.toStringAsFixed(2)} → \$${transaction.roundedAmount!.toStringAsFixed(2)}',
            Icons.auto_graph,
  ...
  bool _hasAdditionalDetails(Transaction transaction) {
    return transaction.originalAmount != null ||
           transaction.notificationSource != null ||
...
// Widget para tarjetas compactas de transacciones
