...
import java.util.Map; // <--- Importación añadida necesaria
...
public class SavingController {
    ...
    public ResponseEntity<SavingDTO> updateSavingGoalProgress(
            ...
            @RequestBody Map<String, Double> payload) { // Ahora acepta un JSON body
        
        Double amount = payload.get("amount"); // Extraemos el monto del mapa
